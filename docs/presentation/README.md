...
- **`Oxbow.pptx`** — native PowerPoint version of the same deck, for venues that
  prefer PowerPoint/Keynote. Uses Calibri + Courier New (ship with Office).

Both are backups of the same content; edit whichever the venue calls for.
