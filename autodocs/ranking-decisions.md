...
*Note from a Human: This is a list that I would have an agent add to whenever I made a choice that would affect rankings, as a sort of self check to ensure that I wasn't just overfitting the system to produce results that look right. -AB*
